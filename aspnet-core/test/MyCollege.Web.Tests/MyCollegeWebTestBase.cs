...
{
    public abstract class MyCollegeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyCollegeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyCollegeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyCollegeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyCollegeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyCollegeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyCollegeDbContext, Task<T>> func)
        {
            T result;
